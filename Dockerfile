...
RUN set -ex \
  ...
  && apt-key adv --keyserver keys.gnupg.net --recv-keys A82653CE4AD6DE81463D45402C0654439BD3F480 || apt-key adv --keyserver pgp.mit.edu --recv-keys A82653CE4AD6DE81463D45402C0654439BD3F480 \
